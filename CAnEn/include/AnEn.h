...
public:
    ...
    bool mode_operational;
    bool mode_quick_sort;
    bool store_similarity_matrices;
    size_t members;
    size_t search_flt_halfsize;
    size_t max_par_nan;
    size_t max_flt_nan;
...
private:
    ...
    boost::multi_array< std::pair<double, int>, 3> similarity_simple;
    ...
    //     * @param search_times The search anenTime::Times;
    //     * @param search_forecast_times The complete search times associated with the search
    //     * forecasts. Indices will be created in regarding to this container.
    ...
    //            bool extend_observations = false,
    //            double test_time = {},
    //            anenTime::Times search_times = {} } const;
    //
    //    
    //    
    //    
