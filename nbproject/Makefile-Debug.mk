...
${OBJECTDIR}/Analogs.o: Analogs.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/local/Cellar/boost/1.67.0_1/include -I/usr/local/Cellar/netcdf/4.6.1_2/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Analogs.o Analogs.cpp
...
${TESTDIR}/TestFiles/f9: ${TESTDIR}/tests/runnerTimes.o ${TESTDIR}/tests/testTimes.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f9 $^ ${LDLIBSOPTIONS}   -lcppunit-1.14.0 -lcppunit -lcppunit `cppunit-config --libs`   
...
${TESTDIR}/tests/runnerTimes.o: tests/runnerTimes.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/local/Cellar/boost/1.67.0_1/include -I/usr/local/Cellar/netcdf/4.6.1_2/include -I/usr/local/Cellar/cppunit/1.14.0/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/runnerTimes.o tests/runnerTimes.cpp


${TESTDIR}/tests/testTimes.o: tests/testTimes.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/local/Cellar/boost/1.67.0_1/include -I/usr/local/Cellar/netcdf/4.6.1_2/include -I/usr/local/Cellar/cppunit/1.14.0/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testTimes.o tests/testTimes.cpp
...
${OBJECTDIR}/Analogs_nomain.o: ${OBJECTDIR}/Analogs.o Analogs.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I/usr/local/Cellar/boost/1.67.0_1/include -I/usr/local/Cellar/netcdf/4.6.1_2/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Analogs_nomain.o Analogs.cpp;\
	else  \
