...
foreach(_expectedTarget eccodes_memfs eccodes_memfs_static eccodes eccodes_static codes_info codes_count codes_split_file grib_histogram grib_filter grib_ls grib_dump grib_merge grib2ppm grib_set grib_get grib_get_data grib_copy grib_compare codes_parser grib_index_build bufr_ls bufr_dump bufr_set bufr_get bufr_copy bufr_compare bufr_index_build gts_get gts_compare gts_copy gts_dump gts_filter gts_ls metar_dump metar_ls metar_compare metar_get metar_filter metar_copy grib_count bufr_count grib_to_netcdf codes_bufr_filter eccodes_f90 eccodes_f90_static tigge_check tigge_name tigge_accumulations tigge_split)
...
# Create imported target eccodes_memfs_static
add_library(eccodes_memfs_static STATIC IMPORTED)

# Create imported target eccodes
add_library(eccodes SHARED IMPORTED)

# Create imported target eccodes_static
add_library(eccodes_static STATIC IMPORTED)
...
# Create imported target eccodes_f90_static
add_library(eccodes_f90_static STATIC IMPORTED)
