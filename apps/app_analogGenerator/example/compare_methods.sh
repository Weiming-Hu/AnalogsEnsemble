...
similarityCalculator --test-forecast-nc ../../../tests/Data/test_forecasts.nc --search-forecast-nc ../../../tests/Data/test_forecasts.nc --observation-nc ../../../tests/Data/test_observations.nc --similarity-nc sim_sep.nc -v 1 --test-start 0 0 9 0 --test-count 5 20 1 8 --search-start 0 0 0 0 --search-count 5 20 9 8 --time-match-mode 1 --mapping-txt map.txt

analogSelector --similarity-nc sim_sep.nc --observation-nc ../../../tests/Data/test_observations.nc --analog-nc analogs_sep.nc --members 5 --mapping-txt map.txt -v 1

analogGenerator --test-forecast-nc ../../../tests/Data/test_forecasts.nc --search-forecast-nc ../../../tests/Data/test_forecasts.nc --observation-nc ../../../tests/Data/test_observations.nc --similarity-nc sim_ctn.nc -v 1 --test-start 0 0 9 0 --test-count 5 20 1 8 --search-start 0 0 0 0 --search-count 5 20 9 8 --time-match-mode 1 --analog-nc analogs_ctn.nc --members 5
