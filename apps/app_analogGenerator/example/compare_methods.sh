...
../../../output/bin/analogSelector --similarity-nc sim_sep.nc --observation-nc ../../../tests/Data/test_observations.nc --analog-nc analogs_sep.nc --members 5 --mapping-txt map.txt -v 1
