...
RCPP_MODULE(Config) {
    ...
    class_<Config>("Config")
            ...
            .field(Config::_SAVE_ANALOGS_TIME_IND.c_str(), &Config::save_analogs_time_index, "Whether to save analogs time index")
            .field(Config::_SAVE_SIMS.c_str(), &Config::save_sims, "Whether to save similarity metrics")
            .field(Config::_SAVE_SIMS_TIME_IND.c_str(), &Config::save_sims_time_index, "Whether to save similarity time index")
